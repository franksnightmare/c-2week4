...
class Signal
{
	// map to store pair of signal with
	// set of signalhandlers
	map<size_t,
		set<SignalHandler>> d_signalHandlerMap;
	...
	private:
		Signal();
		~Signal();
		// calls the signalhanders for the
		// given signal it is linked to all
		// required signals using sigaction
